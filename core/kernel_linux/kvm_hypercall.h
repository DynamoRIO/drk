...
*/
typedef unsigned long (*kvm_hypercall_callback_t)(struct kvm_vcpu *vcpu, unsigned long nr,
 ...
 */
void
kvm_register_hypercall_callback(kvm_hypercall_callback_t callback);
void
kvm_remove_hypercall_callback(kvm_hypercall_callback_t callback);
