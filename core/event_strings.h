...
#define MSG_EXCEPTION_STRING "Application %s (%s).  Unrecoverable Error at PC %s.  Program aborted. %s"
...
#define MSG_SIGSEGV_IN_SECURE_CORE_STRING "Application %s (%s) \n** Received SIG%s at %s %s pc 0x%x in thread %d"
...
#define MSG_CLIENT_LIBRARY_UNLOADABLE_STRING "Application %s (%s). Unable to load client library: %s."
